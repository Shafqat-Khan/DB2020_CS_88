...
namespace DB2020__CS__131
{
    public partial class Report : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select Student.FirstName,Clo.Id as clo_id,Clo.Name as clo_name,Rubric.Details,AssessmentComponent.Name as Component,RubricLevel.Details,RubricLevel.MeasurementLevel,(RubricLevel.MeasurementLevel/(select cast(MAX(RubricLevel.MeasurementLevel) as decimal) from RubricLevel)*AssessmentComponent.TotalMarks) as Obtained  from Student,AssessmentComponent,Rubric,RubricLevel,StudentResult,Clo where AssessmentComponent.RubricId = Rubric.Id and RubricLevel.Id = StudentResult.RubricMeasurementId   and Student.Id = StudentResult.StudentId  and StudentResult.AssessmentComponentId = AssessmentComponent.Id and Clo.Id=Rubric.CloId and clo.Name=@c", con);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            r.pdf(dataGridView1, "Clo wise Report", "Clo Based Evaluation");
