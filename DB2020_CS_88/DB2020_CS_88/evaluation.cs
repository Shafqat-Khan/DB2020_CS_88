    ...
    public partial class evaluation : Form
    {
        ...
        private void evaluation_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                comboBox4.Items.Add(dr["Title"].ToString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           comboBox1.Items.Clear();
            ...
            MessageBox.Show(" Students IDs Loaded Succesfully");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@ai",comboBox4.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@EvaluationDate", Convert.ToDateTime(textbox1.Text));
             cmd.ExecuteNonQuery();
        ...
        {
            var con = Configuration.getInstance().getConnection();
            SqlCommand cmd = new SqlCommand("select Student.FirstName,Rubric.Details,AssessmentComponent.Name as Component,RubricLevel.Details,RubricLevel.MeasurementLevel,(RubricLevel.MeasurementLevel/(select cast(MAX(RubricLevel.MeasurementLevel) as decimal) from RubricLevel)*AssessmentComponent.TotalMarks) as Obtained  from Student,AssessmentComponent,Rubric,RubricLevel,StudentResult where AssessmentComponent.RubricId = Rubric.Id and RubricLevel.Id = StudentResult.RubricMeasurementId   and Student.Id = StudentResult.StudentId  and StudentResult.AssessmentComponentId = AssessmentComponent.Id", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
           ...
           // cmd.Parameters.AddWithValue("@A_cid", comboBox2.Text);
           // cmd.Parameters.AddWithValue("@R_mid", comboBox3.Text);
            cmd.ExecuteNonQuery();
            MessageBox.Show("Result Record Deleted Successfully!!!!!!!");
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            e1.pdf(dataGridView1, "Report By sayyed","Clo Based Evaluation");
