...
namespace DB2020__CS__131
{
    public partial class s_report : Form
    {
        ...
        private void s_report_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                comboBox1.Items.Add(dr["RegistrationNumber"].ToString());
        ...
        {
            s_report r = new s_report();

            r.pdf(dataGridView1, "Student Result", "Clo Based Evaluation");
