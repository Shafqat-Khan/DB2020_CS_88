...
namespace DB2020__CS__131
{
    public partial class Form2 : Form
    {
        ...
        {
            Form2 f3 = new Form2();
            f3.pdf(dataGridView1, "Assessment Report", "Clo Based Evaluation");
        }
